...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Get SSIM score and MSE loss from test images"
    )
    parser.add_argument(
        "--noisy_dir", type=str, required=True, help="Noisy / denoised data directory"
    )
    parser.add_argument(
        "--gt_dir",
        type=str,
        default="../../datasets/test/NIND/ds_fs",
