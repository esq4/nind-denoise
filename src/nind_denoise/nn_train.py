...
if __name__ == "__main__":
    ...
    parser = configargparse.ArgumentParser(
        description=__doc__,
        default_config_files=[nn_common.COMMON_CONFIG_FPATH, DEFAULT_CONFIG_FPATH],
    ...
    parser.add_argument(
        ...
        nargs="*",
        default=[],
        help=f"(space-separated) Debug options (available: {nn_common.DebugOptions})",
    )
    ...
    with (
        ...
        ) and nn_common.DebugOptions.CHECK_DATASET in debug_options:
        ...
        if use_D:
            discriminator = nn_common.Discriminator(
        ...
        if use_D2:
            discriminator2 = nn_common.Discriminator(
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            removed = delete_outperformed_models(
                ...
                model_t="generator",
                keep_all_output_images=nn_common.DebugOptions.KEEP_ALL_OUTPUT_IMAGES
                in debug_options,
            )
